                            ...
                            <div class="col-lg-8 col-md-8">
                                ...
                                <div class="row-bottom">
                                    ...
                                    <ul class="trim-edu-list">
                                        ...
                                        <li>
                                            <div class="trim-edu">
                                                <h4 class="trim-edu-title">Virallia University<span class="title-est">2010 - 2012</span></h4>
                                ...
                                <div class="row-bottom">
                                    ...
                                    <ul class="trim-edu-list">
                                        ...
                                        <li>
                                            <div class="trim-edu">
                                                <h4 class="trim-edu-title">Innvovation Tech<span class="title-est">2013 - 2014</span></h4>
                                        ...
                                        <li>
                                            <div class="trim-edu">
                                                <h4 class="trim-edu-title">Livar Studio<span class="title-est">2014 - 2016</span></h4>
